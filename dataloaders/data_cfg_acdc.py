...
def train_data_cc10(train_size = 10, cval = 0):
    '''
    train-test split from cc215
    Args:
        cval:   random seed
    '''
    assert train_size == 10
    labeled_train_list=["001","002","003","004","005","006","012","013",\
    ...
    labeled_train_list, _ = train_test_split(labeled_train_list, train_size = train_size, random_state = cval)
    return labeled_train_list


def val_data_cc10(fold):
    validate_list =["011","071"]
    validation_sets = {0:["062","095","082"],
            1:["002","022","095"],
            2:["002","062","095"],
            3:["022","062","095"],
            4:["022","062","082"]}
    return validation_sets[int(fold)]
